...
def sort_and_merge_list(ll1, ll2):
    ...
    Рефлексия: Задача сначала кажется простой, но весь ее
    смысл, как будто бы, именно в обработке краевых случаев
    и аккуратном тестировании, чтобы ничего не забыть, на таких
    задачах очень хорошо получается понять суть темы
    """
    sort_list(ll1)
    sort_list(ll2)
